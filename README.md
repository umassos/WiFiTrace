...
Note: WiFiTrace is available in two versions: python and ElasticSearch. This git repository contains that python version of the tool.  The ElasticSearch version, which includes kibana dashboards, is available here [github.com/umassos/elastic-wifitrace](https://github.com/umassos/elastic-wifitrace)
